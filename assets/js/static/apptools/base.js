...
(function() {
  ...
  if (this.Backbone != null) {
    ...
    AppToolsView = (function(_super) {
      ...
      AppToolsView.name = 'AppToolsView';
    ...
    AppToolsModel = (function(_super) {
      ...
      AppToolsModel.name = 'AppToolsModel';
    ...
    AppToolsRouter = (function(_super) {
      ...
      AppToolsRouter.name = 'AppToolsRouter';
    ...
    AppToolsCollection = (function(_super) {
      ...
      AppToolsCollection.name = 'AppToolsCollection';
  ...
  CoreModelAPI = (function(_super) {
    ...
    CoreModelAPI.name = 'CoreModelAPI';
  ...
  CoreEventsAPI = (function(_super) {
    ...
    CoreEventsAPI.name = 'CoreEventsAPI';
    ...
    function CoreEventsAPI(apptools, window) {
      ...
      this.trigger = function() {
        ...
        if (__indexOf.call(_this.registry, event) >= 0) {
          ...
          for (_j = 0, _len1 = event_bridge.length; _j < _len1; _j++) {
            bridge = event_bridge[_j];
  ...
  CoreAgentAPI = (function(_super) {
    ...
    CoreAgentAPI.name = 'CoreAgentAPI';
  ...
  CoreDispatchAPI = (function(_super) {
    ...
    CoreDispatchAPI.name = 'CoreDispatchAPI';
  ...
  CoreStorageAPI = (function(_super) {
    ...
    CoreStorageAPI.name = 'CoreStorageAPI';
  ...
  CoreRPCAPI = (function(_super) {
    ...
    CoreRPCAPI.name = 'CoreRPCAPI';

    function CoreRPCAPI(apptools, window) {
      var original_xhr, _ref, _ref1, _ref2,
        _this = this;
              ...
              if (apptools.agent.capabilities.websockets != null) {
                if ((((_ref3 = _this.state.sockets) != null ? _ref3.enabled : void 0) != null) === true) {
                  if ((((_ref4 = _this.state.sockets) != null ? _ref4["default"] : void 0) != null) === null && ((_ref5 = _this.state.sockets) != null ? (_ref6 = _ref5.open) != null ? _ref6.length : void 0 : void 0) === 0) {
                    socket = new window.WebSocket(_this.state.sockets.default_host);
                    ...
                    _this.state.sockets.open.push(socket);
      ...
      this.rpc = {
        ...
        fulfillRPCRequest: function(config, request, callbacks) {
          ...
          (function(request, callbacks) {
            var amplify, xhr, xhr_action, xhr_settings, _ref3, _ref4,
              _this = this;
            ...
            if ((_ref3 = $.apptools) != null ? (_ref4 = _ref3.sys) != null ? _ref4.drivers : void 0 : void 0) {
      ...
      this.registerAPIMethod = function(api, name, base_uri, config) {
        var amplify, base_settings, resourceId, _ref3, _ref4;
        if ((_ref3 = $.apptools) != null ? (_ref4 = _ref3.sys) != null ? _ref4.drivers : void 0 : void 0) {
          amplify = $.apptools.sys.drivers.resolve('transport', 'amplify');
          if (amplify !== false) {
    ...
    function AppTools(window) {
      ...
      this.sys = {
        ...
        drivers: {
          ...
          storage: {},
          render: {},
          register: function(type, name, mountpoint, registered, inited) {
            _this.sys.drivers[type] = {
              name: name,
              mount: mountpoint,
      ...
      if ((window != null ? window.Modernizr : void 0) != null) {
        ...
        this.sys.integrations.push('modernizr');
      ...
      if ((window != null ? window.Backbone : void 0) != null) {
        ...
        this.sys.integrations.push('backbone');
        AppToolsView.prototype.apptools = this;
        AppToolsModel.prototype.apptools = this;
        AppToolsRouter.prototype.apptools = this;
        AppToolsCollection.prototype.apptools = this;
      }
      if ((window != null ? window.Lawnchair : void 0) != null) {
        this.sys.integrations.push('lawnchair');
        this.lib.lawnchair = window.Lawnchair;
      }
      if ((window != null ? window.amplify : void 0) != null) {
        this.sys.integrations.push('amplify');
        this.lib.amplify = window.amplify;
      }
      if ((window != null ? window.jQuery : void 0) != null) {
        this.sys.integrations.push('jquery');
        this.lib.jquery = window.jQuery;
      }
      if ((window != null ? window.Milk : void 0) != null) {
        this.sys.integrations.push('milk');
        this.lib.milk = window.Milk;
      }
      if ((window != null ? window.Mustache : void 0) != null) {
        this.sys.integrations.push('mustache');
        this.lib.mustache = window.Mustache;
      }
      this.dev = new CoreDevAPI(this, window);
      this.model = new CoreModelAPI(this, window);
      this.events = new CoreEventsAPI(this, window);
      this.agent = new CoreAgentAPI(this, window);
      this.agent.discover();
      this.dispatch = new CoreDispatchAPI(this, window);
      this.api = new CoreRPCAPI(this, window);
      this.user = new CoreUserAPI(this, window);
      this.push = new CorePushAPI(this, window);
      return this.sys.go();
    }
