...
def run(environment):
    ...
    def root(context, environment=environment):
        ...
        if environment.getattr(l_page, 'services'):
            ...
            if l_render_page_object is missing:
                l_render_page_object = environment.undefined("the template %r (imported on line 28 in '/source/core/__south.html') does not export the requested name 'render_page_object'" % included_template.__name__, name='render_page_object')
    ...
    blocks = {}
    debug_info = '3=14&6=15&7=16&8=17&9=18&12=19&13=20&15=22&17=25&26=30&28=33&29=40&31=42&32=45'
    return locals()